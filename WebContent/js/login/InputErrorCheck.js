...
document.getElementById("ZCSex").addEventListener("mouseover", function () { //第二个密码
...
document.getElementById("zc").addEventListener("mouseover", function () { //按下提交时，全部检查
    let all = []
